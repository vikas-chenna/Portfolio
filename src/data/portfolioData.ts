...
export const fallbackPortfolioData: PortfolioData = {
  personal: {
    ...
    careerObjective: "To leverage my skills in full-stack web engineering, database architecture, and artificial intelligence to build transformative digital products for industry-leading tech companies and high-growth startups."
  },
  skills: [
    { name: "HTML5 / CSS3", category: "Frontend", level: 95, icon: "SiHtml5" },
    { name: "JavaScript (ES6+)", category: "Frontend", level: 90, icon: "SiJavascript" },
    ...
    { name: "Java Servlets", category: "Backend", level: 70, icon: "FaJava", status: "Learning" },
    
    { name: "MySQL", category: "Database", level: 88, icon: "SiMysql" },
    { name: "MongoDB Atlas", category: "Database", level: 84, icon: "SiMongodb" },
    
    { name: "Java", category: "Programming", level: 85, icon: "FaJava" },
    { name: "PHP", category: "Programming", level: 88, icon: "SiPhp" },
    { name: "C", category: "Programming", level: 80, icon: "SiC" },
    { name: "C++", category: "Programming", level: 82, icon: "SiCplusplus" },
    { name: "Python", category: "Programming", level: 78, icon: "SiPython" },
    { name: "C#", category: "Programming", level: 75, icon: "SiCsharp" },
    
    { name: "Git & GitHub", category: "Tools", level: 90, icon: "SiGithub" },
    { name: "VS Code", category: "Tools", level: 95, icon: "SiVisualstudiocode" },
    { name: "Postman", category: "Tools", level: 86, icon: "SiPostman" },
    { name: "XAMPP", category: "Tools", level: 88, icon: "SiXampp" },
    { name: "Android Studio", category: "Tools", level: 72, icon: "SiAndroidstudio" },
    { name: "NetBeans", category: "Tools", level: 75, icon: "SiApache" },
    { name: "Visual Studio", category: "Tools", level: 78, icon: "SiVisualstudio" }
  ],
  projects: [
    {
      id: "plantastic",
      ...
      description: "Plantastic is an enterprise-grade multi-user event management web platform that streamlines event planning, ticketing, organizer workflows, and administrator controls with automated email notifications.",
      technologies: ["HTML", "CSS", "JavaScript", "PHP", "MySQL", "Bootstrap", "PHPMailer"],
      features: [
    ...
    },
    {
      ...
      description: "Insight AI is a cutting-edge SaaS intelligence tool designed to transform raw metrics into actionable strategic insights using Large Language Models via OpenRouter API with a sleek glassmorphic dashboard.",
      technologies: ["React", "Vite", "Tailwind CSS", "Node.js", "MongoDB Atlas", "OpenRouter API"],
      features: [
    ...
    },
    {
      ...
      tagline: "Real-time web code playground for Java, PHP, and C++",
      description: "A developer-first online code editor and sandbox environment allowing developers to test, format, and execute snippets in Java, PHP, C, and Python directly from the browser.",
  ...
  experience: [
    {
      ...
      description: "Underwent rigorous hands-on training in Artificial Intelligence fundamentals and Cloud Computing architecture. Engineered a capstone AI application integrating predictive machine learning models and cloud APIs.",
      highlights: [
  ...
  education: [
    {
      ...
      institution: "Department of Computer Science, Veer Narmad South Gujarat University (VNSGU)",
      location: "Surat, Gujarat, India",
      score: "CGPA: 8.0",
      period: "Expected Graduation: 2027",
      status: "In Progress",
      details: "Specializing in Advanced Web Technologies, Software Engineering, Cloud Architectures, and Database Systems."
    },
    {
      ...
      period: "Completed",
      status: "Graduated",
      details: "Focused on Core Programming (Java, C, C++, PHP), Data Structures, Database Management, and Web Development."
    }
  ],
  certifications: [
    {
      ...
      description: "Comprehensive practical program in Machine Learning models, natural language processing basics, and Cloud container deployment."
    },
    {
      ...
      credentialUrl: "#",
      badge: "Full Stack",
      description: "Mastery in modern JavaScript (ES6+), React components, state management, REST API architecture, and database integrations."
    },
    {
      ...
      description: "Advanced relational schema design, query optimization, indexing, stored procedures, and multi-table transactions in MySQL."
    }
  ],
  achievements: [
    {
      ...
      date: "BCA Graduation",
      description: "Achieved CGPA 8.5 in BCA at Bhagwan Mahavir University with top performance in Web Development and Database Management."
    },
    {
      title: "Deployed Production AI SaaS Platform",
      category: "Project Milestone",
      date: "2025",
      description: "Designed, developed, and deployed Insight AI live on Vercel, integrating OpenRouter LLM APIs with Node.js and React."
    },
    {
      title: "IBM Capstone Project Award",
      category: "Internship Recognition",
      date: "IBM SkillsBuild",
      description: "Successfully presented and defended the AI Capstone solution during the 6-week virtual internship with IBM."
    }
  ]
};
